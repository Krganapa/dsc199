...
Below are instructions to setup this project on your local machine using a Anaconda or miniconda environment. Please ensure that you have installed [`git`](https://git-scm.com/) on your machine beforehand.
